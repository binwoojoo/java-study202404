...
public class FilterApple {
     ...
     * @return basket에서 녹샌 사과만 필터링만 리스트
     * @solution try1: 사과 바구니 안에서 색상이 녹색인 사과들만 필터링 하고싶어
     * @problem 만약에 다른 색깔의 사과를 필터링해야 한다면 이 매서드는 한계가 있다.
     */
